...
import com.cyclicsoft.com.model.AdminTest;
...
//    Car Animation
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_finduser= (TextView)findViewById(R.id.tv_find_user);
        tv_finduser.setText(userid);
        Toast.makeText(MapsActivity.this, "LoginUserID" + userid, Toast.LENGTH_SHORT).show();

        Log.d("ppp","entered");
        //startActivity( new Intent(this,LocationService.class));

        Log.d("ppp","entered in");
                ...
                new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        ...
                        if (latitude != null && longitude != null) {
                            ...
                            adminTest.setName("Driver1");
                            adminTest.setLat(latitude);
                            adminTest.setLng(longitude);

                            dbref.child(adminTest.getName()).setValue(adminTest)
...
//                                               // Snackbar.make(adminRegLayout, "FAILED"+e.getMessage(), Snackbar.LENGTH_SHORT).show();
                            ...
                            displayLocation();
                            Log.d("ppp",""+latitude);
                            Toast.makeText(MapsActivity.this, "lat: "+latitude+"lng: "+longitude, Toast.LENGTH_SHORT).show();
                        }
                    }
